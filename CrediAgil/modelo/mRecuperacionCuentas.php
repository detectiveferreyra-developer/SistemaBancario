...
class RecuperacionCuentas
{
    ...
    public function RecuperarCuentasUsuarios($conectarsistema, $Destinatario, $Token, $CodigoRecuperacion)
    {
        ...
        if ($resultado) {
            ...
            header('location:../controlador/cIniciosSesionesUsuarios.php?CrediAgil=confirmacion-recuperacion-cuentas');
        } else {
    ...
    public function CambioContraseniaRecuperacion($conectarsistema, $Correo, $Contrasenia)
    {
        ...
        if ($resultado) {
            // PAGINA DE CONFIRMACION DATOS ENVIADOS CON EXITO
            header('location:../controlador/cIniciosSesionesUsuarios.php?CrediAgil=confirmacion-cambio-contrasenia');
        } else {
            // PAGINA DE ERROR DATOS NO ENVIADOS
            header('location:../controlador/cIniciosSesionesUsuarios.php?CrediAgil=error-cambio-contrasenia');
        }
    }
