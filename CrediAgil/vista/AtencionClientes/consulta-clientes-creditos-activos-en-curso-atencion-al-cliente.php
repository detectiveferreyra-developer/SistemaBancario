...
-->
    ...
    <head>
        ...
        <title>CrediAgil | Listado Solicitudes Cr&eacute;ditos Aprobados Activos </title>
        <!-- Favicon icon -->
    ...
    ***********************************-->
        ...
        ***********************************-->
            <div class="nav-header">
                <a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=inicioatencionclientes" class="brand-logo">
                            ...
                            <ul class="navbar-nav header-right">
                                <li class="nav-item dropdown notification_dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="all-notification" href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=visualizar-mis-notificaciones-usuarios-atencion-clientes">Ver Mis Notificaciones <i class="ti-arrow-right"></i></a>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item dropdown header-profile">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="<?php echo $UrlGlobal ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=perfilatencionclientes" class="dropdown-item ai-icon">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Solicitudes Cr&eacute;ditos Aprobadas Clientes CrediAgil</h4><br>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
													...
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-especifica-solicitudes-creditos-aprobadas-activas-clientes-atencion-clientes&idusuario=';
                                                        echo $filas['idusuarios'];
                                                        echo '"><i class="ti-help-alt"></i> Ver Informaci&oacute;n</a>
														<a class="dropdown-item" href="';
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=sistema-pagos-creditos-CrediAgil-clientes-atencion-al-cliente&idusuario=';
                                                        echo $filas['idusuarios'];
                                                        echo '"><i class="fa fa-money"></i> Pagar Cuotas</a>
														<a class="dropdown-item" href="';
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=impresion-estado-cuenta-cuotas-nuevos-creditos-atencion-al-cliente&idusuario=';
                                                        echo $filas['idusuarios'];
