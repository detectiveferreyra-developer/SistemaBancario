...
?>
        ...
        <title>CrediAgil | Estado Cuenta Cr&eacute;ditos Clientes <?php echo $Gestiones->getComprobacion_EnviarAlHistoricoClientes(); ?> </title>
        <!-- Favicon icon -->
	...
	<td width="65%"><br><br>
        ...
        echo $UrlGlobal;
        echo 'images/CrediAgil.png"><img style="margin: 0 0 0 .5rem; width: 110px;" src="';
        echo $UrlGlobal;
        echo 'images/CrediAgil.png"><br><br>
    ...
    <article style="width: 95%; margin: auto; display: block;">';
        if ($Gestiones->getComprobarEstadoCuotasMensuales() == "no") {
            ...
            $PrimerNombre = explode(' ', $Nombre, 2);
            print_r($PrimerNombre[0]);
            echo ', el respectivo estado de cuenta se ha registrado con �xito en nuestro sistema. Por favor proceda a imprimir y entregar en f�sico este estado de cuenta. Ind&iacute;quele al cliente que en su portal podr&aacute; consultar el mismo con otros extras que son de inter&eacute;s en esta solicitud crediticia.';
        }
        echo '
    ...
    ';
        ...
        echo '
            ...
            <a href="';
        echo $UrlGlobal;
        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=copiacontratosuscrito-creditosclientes&nombrecopiacontrato=';
    ...
    */
        ...
        // FORMATO FECHA DE REGISTRO -> A�O/MES/DIA = YYYY/MM/DD
        // FORMATO FECHA DE MUESTRA CLIENTES -> DIA/MES/A�O = DD/MM/YYYY
    ...
    -> MOTIVO: PARA EVITAR CALCULOS ERRONEOS DE FECHAS EN EL MES DE FEBRERO PRINCIPALMENTE, CUANDO EL A�O ES BISIESTO O SIMPLEMENTE EL INGRESO DE LA SOLICITUD EXCEDE LOS 28 DIAS DEL << X >> MES DE INGRESO Y REGISTRO Y EVITAR FECHAS INVALIDAS [NO EXISTENTES] AL MOMENTO DE RECALCULAR LAS FECHAS DE PAGO
