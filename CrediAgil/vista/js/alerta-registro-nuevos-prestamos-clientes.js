$(document).ready(function () {
    $("#ingreso-datos-credito-clientes").on('submit', (function (e) { // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
        ...
        if ($FechaInicioClienteCreditos === "") {
            ...
            $.ajax({
                url: "../controlador/cGestionesCrediAgil.php?CrediAgilgestion=envio-datos-asignacion-prestamos-CrediAgil-clientes",
                type: "POST",
                dataType: 'json',
                ...
                if ($resultado === "OK") {
                    ...
                    setTimeout(function () {
                        //location.reload();
                        location.href ="../controlador/cGestionesCrediAgil.php?CrediAgilgestion=gestor-creditos-referencias-personales-clientes&idusuario="+IDUsuarios;
                    }, 1500);
