                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Listado Reportes de Fallos - Plataforma CrediAgil</h4><br>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
													...
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-especifica-tickets-reportes-plataforma&idreporte=';
                                                        echo $filas['idreporte'];
