...
-->
    ...
    <head>
        ...
        <title>CrediAgil | Sistema Pagos Cr&eacute;ditos CrediAgil </title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Pagadur&iacute;a Clientes CrediAgil</h4>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted">Cliente CrediAgil</p>
						...
						<tr>
                            ...
                            <td>';
                                                            if ($filas['estadocuota'] == "pendiente") {
                                                                echo '<a href="';
                                                                echo $UrlGlobal;
                                                                echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=orden-pago-creditos-CrediAgil-clientes-atencion-al-cliente&idcuota=';
                                                                echo $filas['idcuotas'];
                                                                echo '&idusuario=';
                                                                ...
                                                                echo '<a href="';
                                                                echo $UrlGlobal;
                                                                echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=facturacion-pago-ordenes-pago-cuotas-clientes&idcuota=';
                                                                echo $filas['idcuotas'];
                                                                echo '&idusuario=';
                                                                echo $filas['idusuarios'];
