					...
					<div class="authincation-content">
						<div class="row no-gutters">
							<div class="col-xl-12">
								<div class="auth-form">
									<form
										action="<?php echo $UrlGlobal; ?>controlador/cIniciosSesionesUsuarios.php?CrediAgil=iniciarsesion"
										method="POST">
										<img class="logo-abbr logo-formulario"
											src="<?php echo $UrlGlobal; ?>images/CrediAgil_azul.jpg" alt="logo-simple">
										<div class="text-center">
											<h2 class="text-white"><i class="fa fa-times-circle text-danger"></i>
												Upss... Error</h2>
											<p class="text-white">Lo sentimos, ha ocurrido un error, por favor verifique
												que su usuario y/o contrase&ntilde;a ingresados sean v&aacute;lidos.</p>
											<button type="submit" class="btn btn-primary btn-block">Volver al
												Inicio</button>
										</div>
									</form>
								</div>
