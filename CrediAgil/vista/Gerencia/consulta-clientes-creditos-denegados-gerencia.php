                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Cr&eacute;ditos Rechazados</a>
                            </li>
                        </ol>
                    </div>
                    <div class="row">
                                ...
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        ...
                                        print_r($PrimerNombre[0]); ?>, en este apartado
                                            ...
                                            cr&eacute;ditos han sido rechazadas. <strong>Es importante enviar al
                                                hist&oacute;rico las diferentes solicitudes presentadas ac&aacute;, de lo
                                                contrario nuevas solicitudes crediticias no podr&aacute;n ser procesadas si
                                                se encuentra a&uacute;n activo un registro en las asignaciones de
                                                cr&eacute;ditos principales</strong></p>
