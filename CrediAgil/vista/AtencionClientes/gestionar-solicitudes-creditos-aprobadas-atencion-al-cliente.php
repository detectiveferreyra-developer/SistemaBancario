                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Consulta Solicitudes Cr&eacute;ditos Aprobadas Clientes CrediAgil</h4><br>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
													...
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=gestionador-cuotas-contratos-solicitudes-creditos-clientes-atencion-al-cliente&idusuario=';
