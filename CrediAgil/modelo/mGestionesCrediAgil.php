...
class GestionesClientes
{
    ...
    // -> CREDITOS CrediÃgil [AUXILIAR]
    private $IdCreditosAuxiliar;
    // -> CREDITOS CrediÃgil [CONSULTA COMPLETA NO AUXILIAR]
    private $IdCreditos;
    ...
    // -> RERERENCIAS PERSONALES - LABORALES -> CLIENTES CrediÃgil 
    ...
    /*
            << REFERENCIAS PERSONALES - LABORALES CREDITOS CrediÃgil >>
    ...
    /*
            << REFERENCIAS PERSONALES -> LABORALES CrediÃgil >>
    ...
    /*
            << CONSULTA DE MENSAJERIA CrediÃgil USUARIOS >>
    ...
    /*
            << CONSULTA DATOS TRANSFERENCIAS CLIENTES -> CUENTAS DE DESTINO FINAL CrediÃgil >>
        */
    ...
    // CONSULTAR DETALLES DE USUARIOS -> MI PERFIL
    public function ConsultaGeneralProductosCrediAgil($conectarsistema, $IdProductos)
    {
    ...
    // REGISTRAR NUEVOS PRODUCTOS CrediAgil -> USO EXCLUSIVO ROL [ADMINISTRADORES]
    ...
    {
        $resultado = mysqli_query($conectarsistema, "CALL RegistrarNuevosProductosCrediAgil('" . $CodigoProductos . "','" . $NombreProductos . "','" . $DescripcionProductos . "','" . $RequisitosProductos . "','" . $EstadoProductos . "');");
        return $resultado;
    }
    // CONSULTA GENERAL DE PRODUCTOS REGISTRADOS CrediAgil [ACTIVOS] -> EMPLEADOS - ADMINISTRADOR
    public function ConsultarProductosCrediAgil_Activos($conectarsistema)
    {
        $resultado = mysqli_query($conectarsistema, "CALL ConsultarProductosCrediAgilRegistrados_Activos()");
        return $resultado;
    }
    // CONSULTA GENERAL DE PRODUCTOS REGISTRADOS CrediAgil [INACTIVOS] -> EMPLEADOS - ADMINISTRADOR
    public function ConsultarProductosCrediAgil_Inactivos($conectarsistema)
    {
        $resultado = mysqli_query($conectarsistema, "CALL ConsultarProductosCrediAgilRegistrados_Inactivos()");
        return $resultado;
    }
    // CONSULTA GENERAL DE PRODUCTOS REGISTRADOS CrediAgil [EXPIRADOS] -> EMPLEADOS - ADMINISTRADOR
    public function ConsultarProductosCrediAgil_Expirados($conectarsistema)
    {
        $resultado = mysqli_query($conectarsistema, "CALL ConsultarProductosCrediAgilRegistrados_Expirados()");
        return $resultado;
    }
    // ACTIVAR PRODUCTOS REGISTRADOS -> ADMINISTRADORES, PRESIDENCIA, GERENCIA
    public function ActivarProductosCrediAgil($conectarsistema, $IdProductos)
    {
        $resultado = mysqli_query($conectarsistema, "CALL ActivarProductosCrediAgil('" . $IdProductos . "');");
        if ($resultado) {
            return "OK";
        } else {
            return "ERROR";
    ...
    public function DesactivarProductosCrediAgil($conectarsistema, $IdProductos)
    {
        $resultado = mysqli_query($conectarsistema, "CALL DesactivarProductosCrediAgil('" . $IdProductos . "');");
        if ($resultado) {
            return "OK";
        } else {
            return "ERROR";
    ...
    public function ExpirarProductosCrediAgil($conectarsistema, $IdProductos)
    {
        $resultado = mysqli_query($conectarsistema, "CALL ExpirarProductosCrediAgil('" . $IdProductos . "');");
        if ($resultado) {
            return "OK";
        } else {
            return "ERROR";
    ...
    // MODIFICAR PRODUCTOS CrediAgil -> [ADMINISTRADORES, PRESIDENCIA, GERENCIA]
    ...
    {
        $resultado = mysqli_query($conectarsistema, "CALL ModificarProductosRegistradosCrediAgil('" . $IdProductos . "','" . $CodigoProductos . "','" . $NombreProductos . "','" . $DescripcionProductos . "','" . $RequisitosProductos . "','" . $EstadoProductos . "');");
        if ($resultado) {
            return "OK";
        } else {
            return "ERROR";
    ...
    // CONSULTA GENERAL DE PRODUCTOS REGISTRADOS CrediAgil ACTIVOS -> CAMPO SELECT NUEVOS CREDITOS
    ...
    // CONSULTA ESPECIFICA DE CUOTAS GENERADAS CLIENTES CrediÃgil -> CREDITOS ACTIVOS [EN CURSO]
    ...
    // CONSULTA ESPECIFICA DE CUOTAS GENERADAS CLIENTES CrediÃgil -> CREDITOS CANCELADOS [HISTORICOS]
    ...
    {
        $resultado = mysqli_query($conectarsistema, "CALL RegistroPagoCuotasCreditosClientes_OrdenPagosCrediAgil ('" . $IdUsuarios . "','" . $IdProductos . "','" . $IdCreditos . "','" . $IdCuotas . "','" . $NumeroReferenciaTransaccion . "','" . $MontoCuotaCredito . "','" . $DiasIncumplimientoCredito . "','" . $EmpleadoGestionTransaccion . "');");
        if ($resultado) {
            return "OK";
        } else {
            return "ERROR";
    ...
    {
        $resultado = mysqli_query($conectarsistema, "CALL MostrarDetallesDatosClientes_FacturacionCreditosCrediAgil('" . $IdCuotas . "','" . $IdUsuarios . "');");
        $Gestiones = mysqli_fetch_array($resultado); // RECORRIDO EN BUSCA DE REGISTRO CONSULTADO
        // EXTRAER DETALLES DE USUARIOS SOLAMENTE SI EXISTEN REGISTROS QUE SE SEAN ASOCIADOS
        // AL USUARIO QUE ESTA SIENDO CONSULTADO EN CUESTION Y NO SEA CONSULTA VACIA [NULA]
        if (mysqli_num_rows($resultado) > 0) {
    ...
    {
        $resultado = mysqli_query($conectarsistema, "CALL MostrarDetallesDatosClientes_FacturacionCreditosCrediAgil('" . $IdUsuarios . "','" . $IdCuotas . "');");
        $Gestiones = mysqli_fetch_array($resultado); // RECORRIDO EN BUSCA DE REGISTRO CONSULTADO
        // EXTRAER DETALLES DE USUARIOS SOLAMENTE SI EXISTEN REGISTROS QUE SE SEAN ASOCIADOS
        // AL USUARIO QUE ESTA SIENDO CONSULTADO EN CUESTION Y NO SEA CONSULTA VACIA [NULA]
        if (mysqli_num_rows($resultado) > 0) {
    ...
    // CONSULTA BANDEJA DE ENTRADA -> MENSAJERIA USUARIOS CrediÃgil
    public function ConsultarMensajesBandejaEntradaUsuarios($conectarsistema, $IdUsuarios)
    {
        $resultado = mysqli_query($conectarsistema, "CALL ConsultaMensajesBandejaEntradaUsuariosCrediAgil('" . $IdUsuarios . "');");
        return $resultado;
    }
    // CONSULTA DETALLES DE MENSAJERIAS BANDEJA DE ENTRADA -> MENSAJERIA USUARIOS CrediÃgil
    public function ConsultarDetallesMensajesBandejaEntradaUsuarios($conectarsistema, $IdUsuarios, $IdMensaje)
    {
        $resultado = mysqli_query($conectarsistema, "CALL ConsultarDetallesMensajesBandejaEntradaUsuariosCrediAgil('" . $IdUsuarios . "','" . $IdMensaje . "');");
        $Gestiones = mysqli_fetch_array($resultado); // RECORRIDO EN BUSCA DE REGISTRO CONSULTADO
        // EXTRAER DETALLES DE USUARIOS SOLAMENTE SI EXISTEN REGISTROS QUE SE SEAN ASOCIADOS
        // AL USUARIO QUE ESTA SIENDO CONSULTADO EN CUESTION Y NO SEA CONSULTA VACIA [NULA]
        if (mysqli_num_rows($resultado) > 0) {
    ...
    // CONSULTA DE TODOS LOS USUARIOS REGISTRADOS DISPONIBLES PARA ENVIO DE MENSAJERIA INTERNA CrediÃgil
    public function ConsultarListadoUsuariosCompleto_MensajeriaCrediAgil($conectarsistema)
    {
        $resultado = mysqli_query($conectarsistema, "CALL ConsultaNombresCompletos_EnviarMensajeriaNuevaUsuariosCrediAgil();");
        return $resultado;
    }
    // REGISTRO DE NUEVOS MENSAJES -> ENVIO MENSAJERIA INTERNA CrediÃgil
    public function EnvioNuevosMensajes_MensajeriaInternaCrediAgil($conectarsistema, $IdUsuarios, $NombreMensajeria, $AsuntoMensajeria, $DetalleMensajeria, $IdUsuarioDestinatarioMensajeria)
    {
        $resultado = mysqli_query($conectarsistema, "CALL RegistroNuevosMensajesUsuarios_MensajeriaCrediAgil ('" . $IdUsuarios . "','" . $NombreMensajeria . "','" . $AsuntoMensajeria . "','" . $DetalleMensajeria . "','" . $IdUsuarioDestinatarioMensajeria . "');");
        if ($resultado) {
            return "OK";
        } else {
            return "ERROR";
    ...
    // OCULTAR MENSAJES RECIBIDOS -> MENSAJERIA INTERNA CrediÃgil 
    public function OcultarMensajes_MensajeriaInternaCrediAgil($conectarsistema, $IdMensajeria)
    {
        $resultado = mysqli_query($conectarsistema, "CALL OcultarMensajesRecibidos_MensajeriaInternaUsuariosCrediAgil ('" . $IdMensajeria . "');");
        if ($resultado) {
            return "OK";
        } else {
            return "ERROR";
    ...
    // CONSULTA AVANCE DE CREDITOS ASIGNADOS CLIENTES -> VALIDO PARA INTERFAZ DE INICIO CLIENTE CrediÃ gil
    public function ConsultarAvanceCreditos_ClientesCrediAgilInterfaz($conectarsistema, $IdUsuarios)
    {
