    ...
    ***********************************-->
        ...
        ***********************************-->
            <div class="nav-header">
                <a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=iniciopresidencia"
                    class="brand-logo">
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            ...
                            <ul class="navbar-nav header-right">
                                <li class="nav-item dropdown notification_dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="all-notification"
                                            href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=visualizar-mis-notificaciones-usuarios-presidencia">Ver
                                ...
                                <li class="nav-item dropdown header-profile">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="<?php echo $UrlGlobal ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=perfilpresidencia"
                                        ...
                                        <a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=mensajeria-CrediAgil-usuarios-presidencia"
                                            class="dropdown-item ai-icon">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="card-tech-detail tech-transactions">
                                                <div class="info">
                                                    <span>Transacciones Cr&eacute;ditos Registradas</span>
                                                    <h2><?php echo $Gestiones->getNumeroTransaccionesClientesRegistradas(); ?>
                                                    </h2>
                                                </div>
                                                <div class="icon-box">
                                                    <img src="<?php echo $UrlGlobal; ?>vista/images/cash.gif" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="card-tech-detail tech-users">
                                                <div class="info">
                                                    <span>Cuotas Canceladas Tarde</span>
                                                    <h2><?php echo $Gestiones->getNumeroCuotasPagadasTarde(); ?></h2>
                                                </div>
                                                <div class="icon-box">
                                                    <img src="<?php echo $UrlGlobal; ?>vista/images/warning.gif" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="card-tech-detail tech-errors">
                                                <div class="info">
                                                    <span>Cuotas Procesadas / Canceladas</span>
                                                    <h2><?php echo $Gestiones->getNumeroCuotasPagadasCanceladas(); ?></h2>
                                                </div>
                                                <div class="icon-box">
                                                    <img src="<?php echo $UrlGlobal; ?>vista/images/handshake.gif" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="card-tech-detail tech-recovery">
                                                <div class="info">
                                                    <span>Cuentas Vencidas / No Procesadas</span>
                                                    <h2><?php echo $Gestiones->getNumeroCuotasVencidas(); ?></h2>
                                                </div>
                                                <div class="icon-box">
                                                    <img src="<?php echo $UrlGlobal; ?>vista/images/no.gif" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-12 col-xxl-12 col-lg-12 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-footer border-0 pt-0 text-center">
                                    <a href="javascript:void(0);" class="btn-link"> <i
                                            class="fa fa-caret-right ml-2 scale-2"></i> Transacciones Cr&eacute;ditos
                                        Clientes</a>
                                </div>
                            </div>
                        </div>
