...
-->
	...
	<head>
	    ...
	    <title>CrediAgil | Error Inicio Sesi&oacute;n</title>
	    <!-- Favicon icon -->
	                ...
	                <div class="col-md-6">
	                    <div class="authincation-content">
	                        <div class="row no-gutters">
	                            <div class="col-xl-12">
	                                <div class="auth-form">
	                                    <form action="<?php echo $UrlGlobal; ?>controlador/cIniciosSesionesUsuarios.php?CrediAgil=iniciarsesion" method="POST">
