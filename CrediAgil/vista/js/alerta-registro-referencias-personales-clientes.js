$(document).ready(function () {
    $("#ingreso-datos-referencias-clientes").on('submit', (function (e) { // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
        ...
        if ($TelefonoReferenciaLaboral === "") {
            ...
            $.ajax({
                url: "../controlador/cGestionesCrediAgil.php?CrediAgilgestion=envio-datos-asignacion-nuevas-referencias-personales-laborales-clientes",
                type: "POST",
                dataType: 'json',
                ...
                if ($resultado === "OK") {
                    ...
                    AlertaUsuarioMostrar("Registro Exitoso", "Perfecto, las referencias solicitadas han sido ingresadas con éxito.", "success");
