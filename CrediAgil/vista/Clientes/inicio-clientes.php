...
-->
    ...
    ***********************************-->
        ...
        ***********************************-->
                <div class="nav-header">
                    <a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=inicioclientes"
                        class="brand-logo">
                                ...
                                <ul class="navbar-nav header-right">
                                    <li class="nav-item dropdown notification_dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="all-notification"
                                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=visualizar-mis-notificaciones-usuarios-clientes">Ver
                                    ...
                                    */
                                    ...
                                    <li class="nav-item dropdown header-profile">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="<?php echo $UrlGlobal ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=perfilclientes"
                                            ...
                                            <div class="bootstrap-media">
                                                <div class="media">
                                                    <div class="left-panel panel">
                                                        ...
                                                        <div class="city">
                                                            <h2
                                                                style="padding: 1rem 0 0 1rem; font-size: 1.4rem; font-weight: bold; text-transform: uppercase;">
                                                                San Salvador, El Salvador</h2>
                                                        </div>
                                                        <div class="temp">
                                                            <?php
                                                            // RANGO DE HORAS DESDE 06:00 HASTA 18:00 [A.M -> P.M -> [[DIA]]]
                                ...
                                <div class="col-xl-12 col-xxl-12 col-lg-12">
                                    <div class="card">
                                            ...
                                            <div class="dropdown custom-dropdown mb-0 mt-3 mt-sm-0">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item"
                                                        href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=impresion-estado-cuenta-cuotas-nuevos-creditos-portal-clientes"><i
                                                            class="fa fa-search"></i> Ver Estado de Cuenta</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                        ...
                                        ?>/100</span>
                                                ...
                                                <div class="media-body">
                                                    <p class="mb-2"><?php echo $Gestiones->getNombreProductos(); ?>
                                                        [<?php echo $Gestiones->getCodigoProductos(); ?>]</p>
                                    ...
                                    <?php if ($CalcularAvanceCuotas == 100) { ?>
                                        <div class="alert alert-info alert-dismissible alert-alt fade show">
                                            <strong>¡Atenci&oacute;n!</strong> Estimado cliente, usted ha finalizado de pagar su
                                            solicitud crediticia. En los pr&oacute;ximos 7 d&iacute;as h&aacute;biles ser&aacute;
                                            cont&aacute;ctado para retirar su respectivo finiquito de cancelaci&oacute;n. Gracias por
                                            confiar en nuestra empresa, su usuario seguir&aacute; vigente y a disposici&oacute;n de
                                            obtener un nuevo producto con nosotros.<br><br><strong><i class="fa fa-clock-o"></i> Nota:
                                                Toda la informaci&oacute;n de transacciones de su solicitud ser&aacute; retirada de su
                                                portal como cr&eacute;dito activo. Podr&aacute; consultarla en el hist&oacute;rico de
                                                cr&eacute;ditos.</strong>
                                        <?php } ?>
                                    </div>
                                </div>
                            <?php } ?>
                            <div class="col-xl-12 col-xxl-12 col-lg-12 col-sm-12">
                                <div class="card">
                                    <div class="card-header border-0">
                                        ...
                                        <p class="mb-0 fs-13">Detalle de las &uacute;ltimas 50 transacciones procesadas
                                    ...
                                    <a href="';
                                        echo $UrlGlobal;
                                        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-general-mis-transacciones-procesadas-portal-cliente" class="btn-link">Ver Listado Completo <i class="fa fa-caret-right ml-2 scale-2"></i></a>
                                </div>
                                    ';
                                    }
                                    ?>
    ...
    ***********************************-->
    ...
    <?php } else {
        header('location:../controlador/cGestionesCrediAgil.php?CrediAgilgestion=bienvenida-clientes');
    }
} ?>