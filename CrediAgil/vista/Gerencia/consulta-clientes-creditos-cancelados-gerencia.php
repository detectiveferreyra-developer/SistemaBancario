                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Cr&eacute;ditos Cancelados</a>
                            </li>
                        </ol>
                    </div>
                    <div class="row">
                                ...
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        ...
                                        print_r($PrimerNombre[0]); ?>, en este apartado
                                            ...
                                            cr&eacute;ditos han sido aprobadas y que han finalizado su responsabilidad
                                            crediticia con la empresa. <strong>Una vez el cliente cancela su &uacute;ltima
                                                cuota, le debe ser entregado el respectivo finiquito en f&iacute;sico en un
                                                plazo no mayor a los 7 d&iacute;as de su &uacute;ltimo movimiento.</strong>
                                        </p>
