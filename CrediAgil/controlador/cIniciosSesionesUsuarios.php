    ...
    */
    ...
    case "recuperar-cuentas":
        ...
        try {
            ...
            <h1><a href='#'><img style='width: 70px;' src='http://localhost:90/SistemaBancario/CrediAgil/images/CrediAgil.png'></a></h1>
            </td>
            </tr>
            </table>
            </td>
            ...
            <img src='http://localhost:90/SistemaBancario/CrediAgil/vista/images/submit-progress.gif' style='width: 300px; max-width: 200px; height: auto; margin: auto; display: block;'>
            </td>
            </tr>
            <tr>
        ...
        if (empty($_POST['val-password'])) {
            ...
            try {
                ...
                $mail->Body = "
                    ...
                    <tr>
                    <td valign='middle' class='hero bg_white' style='padding: 3em 0 2em 0; background: #ffffff;'>
                    <img src='http://localhost:90/SistemaBancario/CrediAgil/vista/images/deal.png' style='width: 300px; max-width: 200px; height: auto; margin: auto; display: block;'>
                    </td>
                    </tr>
                    <tr>
                    <td valign='middle' class='hero bg_white' style='padding: 2em 0 4em 0; background: #ffffff;'>
