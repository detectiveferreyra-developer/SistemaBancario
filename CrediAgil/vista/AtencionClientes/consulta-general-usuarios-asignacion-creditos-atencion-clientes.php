...
-->
    ...
    <head>
        ...
        <title>CrediAgil | Asignaci&oacute;n Nuevos Cr&eacute;ditos</title>
        <!-- Favicon icon -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Asignar Nuevos Cr&eacute;ditos Clientes CrediAgil</h4><br>
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a target="_blank" class="dropdown-item" href="';
                                                                echo $UrlGlobal;
                                                                echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=gestor-creditos-clientes-informacion&idusuario=';
