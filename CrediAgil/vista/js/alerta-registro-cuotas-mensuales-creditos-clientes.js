$(document).ready(function () {
    $("#ingreso-datos-cuotas-mensuales-clientes").on('submit', (function (e) { // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
        ...
        if ($MontoCapitalEstadoCuenta === "") {
            ...
            $.ajax({
                url: "../controlador/cGestionesCrediAgil.php?CrediAgilgestion=envio-datos-estado-cuenta-creditos-clientes",
                type: "POST",
                dataType: 'json',
