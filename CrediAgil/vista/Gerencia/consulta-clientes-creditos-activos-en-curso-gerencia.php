                                                ...
                                                <table style="width: 100%;" id="example5" class="display min-w850">
													...
													<div class="dropdown ml-auto text-right">
														...
														<a class="dropdown-item" href="';
                                                            echo $UrlGlobal;
                                                            echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-especifica-solicitudes-creditos-aprobadas-activas-clientes-gerencia&idusuario=';
                                                            echo $filas['idusuarios'];
                                                            echo '"><i class="ti-help-alt"></i> Ver Informaci&oacute;n</a>
														<a class="dropdown-item" href="';
                                                            echo $UrlGlobal;
                                                            echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=impresion-estado-cuenta-cuotas-nuevos-creditos-gerencia&idusuario=';
                                                            echo $filas['idusuarios'];
                                                            echo '"><i class="fa fa-bank"></i> Estado de Cuenta</a>
														<a class="dropdown-item" href="';
                                                            echo $UrlGlobal;
                                                            echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-general-transacciones-procesadas-por-clientes-gerencia&idusuario=';
                                                            echo $filas['idusuarios'];
