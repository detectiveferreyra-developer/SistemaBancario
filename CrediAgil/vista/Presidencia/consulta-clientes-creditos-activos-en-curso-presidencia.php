                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
													...
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-especifica-solicitudes-creditos-aprobadas-activas-clientes-presidencia&idusuario=';
                                                        echo $filas['idusuarios'];
                                                        echo '"><i class="ti-help-alt"></i> Ver Informaci&oacute;n</a>
														<a class="dropdown-item" href="';
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=impresion-estado-cuenta-cuotas-nuevos-creditos-presidencia&idusuario=';
                                                        echo $filas['idusuarios'];
                                                        echo '"><i class="fa fa-bank"></i> Estado de Cuenta</a>
														<a class="dropdown-item" href="';
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-general-transacciones-procesadas-por-clientes-presidencia&idusuario=';
                                                        echo $filas['idusuarios'];
