...
if ($_SESSION['comprobar_iniciosesion_primeravez'] == "si") {
    ...
    */
    ...
    if ($EdadActualClientes >= 18 && $EdadActualClientes <= 70) {
        ...
        <head>
            ...
            <title>CrediAgil | Seleccionar Producto CrediAgil</title>
            <!-- Favicon icon -->
                        ...
                        <div class="col-md-10">
                            <div class="authincation-content">
                                <div class="row no-gutters">
                                    <div class="col-xl-12">
                                        <div class="auth-form">
                                            <p style="display: flex; justify-content: flex-end;"><span
                                                    class="badge badge-rounded badge-outline-light">Empleado:
                                                    <?php echo $_SESSION['usuario_unico']; ?></span></p>
                                            ...
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="text-center">
                                                        ...
                                                        <h3 class="mt-4 mb-1"><?php echo $Gestiones->getNombresUsuarios(); ?>
                                                            <?php echo $Gestiones->getApellidosUsuarios(); ?></h3>
                                                        <p>Cliente CrediAgil</p>
                                                        <p>Seleccionar Producto CrediAgil</p>
                                                    </div>
                                                    <div class="col-xl-12">
                                            ...
                                            <li><a href="';
                                                                ...
                                                                if ($filas['nombreproducto'] == "Pr�stamos Personales") {
                                                                    echo $UrlGlobal;
                                                                ...
                                                                if ($filas['nombreproducto'] == "Pr�stamos Hipotecarios") {
                                                                    echo $UrlGlobal;
                                                                ...
                                                                if ($filas['nombreproducto'] == "Pr�stamos de Veh�culos") {
                                                                    echo $UrlGlobal;
    ...
    ***********************************-->
                        ...
                        <script
                            src="<?php echo $UrlGlobal; ?>vista/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
