								...
								<li class="nav-item dropdown notification_dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										...
										<a class="all-notification"
											href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=visualizar-mis-notificaciones-usuarios">Ver
			...
			<div class="content-body">
				<div class="container-fluid">
					...
					<script>
						...
						// Waiting for DOM ready and Table init
						document.addEventListener("DOMContentLoaded", function () {
							// Helper to wait for jQuery and DataTable
							...
							<div class="tab-content tabcontent-border">
								<div class="tab-pane fade show active" id="home8" role="tabpanel">
									<div class="pt-4">
										...
										$PrimerNombre = explode(' ', $Nombre, 2);
										print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todos los
											clientes que su solicitud de cr&eacute;ditos han sido aprobadas. <strong>Usted
												podr&aacute; consultar y ver el avence de todas las solicitudes
												registradas.</strong></p>
											...
											<table style="width: 100%;" id="example5" class="display min-w850">
												...
												<tbody>
													...
													<div class="dropdown ml-auto text-right">
														...
														<a class="dropdown-item" href="';
														echo $UrlGlobal;
														echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=sistema-pagos-creditos-CrediAgil-clientes&idusuario=';
														echo $filas['idusuarios'];
														echo '"><i class="fa fa-money"></i> Pagar Cuotas</a>
														<a class="dropdown-item" href="';
														echo $UrlGlobal;
														echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=impresion-estado-cuenta-cuotas-nuevos-creditos&idusuario=';
														echo $filas['idusuarios'];
														echo '"><i class="fa fa-bank"></i> Estado de Cuenta</a>
														<a class="dropdown-item" href="';
														echo $UrlGlobal;
														echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-general-transacciones-procesadas-por-clientes&idusuario=';
														echo $filas['idusuarios'];
