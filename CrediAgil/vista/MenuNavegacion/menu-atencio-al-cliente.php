            ...
            <ul class="metismenu" id="menu">
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
                    ...
                    <ul aria-expanded="false">
                        <li><a
                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=inicioatencionclientes">Mi
                                Inicio</a></li>
                        <li><a
                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=perfilatencionclientes">Mi
                                Perfil</a></li>
                    </ul>
                </li>
                <li <?php if ($_GET['CrediAgilgestion'] == "consulta-productos-especifica-CrediAgil-gerencia" || $_GET['CrediAgilgestion'] == "modificar-productos-CrediAgil-gerencia") {
                    ...
                    <ul aria-expanded="false">
                        ...
                        } ?>   href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=consultar-productos-CrediAgil-atencion-clientes">Consultar
                                Productos</a></li>
                    </ul>
                </li>
                <li><a class="ai-icon"
                ...
                <li <?php if ($_GET['CrediAgilgestion'] == "sistema-pagos-creditos-CrediAgil-clientes" || $_GET['CrediAgilgestion'] == "orden-pago-creditos-CrediAgil-clientes") {
                    ...
                    <ul aria-expanded="false">
                        <li><a <?php if ($_GET['CrediAgilgestion'] == "sistema-pagos-creditos-CrediAgil-clientes") {
                            echo 'class="active-element-menu"';
                        } ?>   href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=listado-general-creditos-aprobados-activos-atencion-al-cliente">Listado
                                de Clientes</a></li>
                ...
                <li <?php if ($_GET['CrediAgilgestion'] == "consulta-especifica-solicitudes-creditos-aprobadas-activas-clientes") {
                    ...
                    <ul aria-expanded="false">
                        <li><a
                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=asignacion-nuevos-creditos-clientes-atencion-al-cliente">Asignar
                        ...
                        <li><a <?php if ($_GET['CrediAgilgestion'] == "consulta-especifica-solicitudes-creditos-aprobadas-activas-clientes") {
                            echo "class='active-element-menu'";
                        } ?> href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=listado-general-creditos-aprobados-activos-atencion-al-cliente">Cr&eacute;ditos
                                Aprobados</a></li>
                        <li><a
                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=listado-general-creditos-cancelados-atencion-clientes">Cr&eacute;ditos
                                Cancelados</a></li>
                        <li><a
                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-gestiones-creditos-clientes-aprobadas-atencion-clientes">Contratos
                                y Cuotas [Solicitudes Aprobadas]</a></li>
                    </ul>
                </li>
                ...
                <li <?php if ($_GET['CrediAgilgestion'] == "consulta-especifica-tickets-reportes-plataforma") {
                    ...
                    <ul aria-expanded="false">
                        <li><a
                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=registrar-ticket-problema-plataforma-atencion-clientes">Registrar
                                Reportes Problemas</a></li>
                    </ul>
                </li>

                <li><a class="ai-icon"
                        href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=visualizar-mis-notificaciones-usuarios-atencion-clientes"
                        aria-expanded="true">
                        <svg fill="LightSlateGrey" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                            height="24">
                            <path fill="none" d="M0 0h24v24H0z" />
