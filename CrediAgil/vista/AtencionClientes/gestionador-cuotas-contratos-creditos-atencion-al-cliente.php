                                                            ...
                                                            <div class="read-content-attachment">
                                                                ...
                                                                <div class="row attachment">
                                                                    <div class="col-auto">
                                                                        ...
                                                                        <a target="_blank" href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=impresion-estado-cuenta-cuotas-nuevos-creditos-atencion-al-cliente&idusuario=<?php echo $Gestiones->getIdUsuarios(); ?>" class="btn btn-outline-info"><i class="fa fa-hourglass-start"></i> Generar Estado de Cuenta</a><br>
