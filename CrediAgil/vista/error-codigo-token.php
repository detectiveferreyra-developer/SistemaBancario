...
<head>
    ...
    <title>CrediAgil | Error C&oacute;digo de Seguridad</title>
    <!-- Favicon icon -->
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form class="form-valide" method="POST" action="<?php echo $UrlGlobal; ?>controlador/cIniciosSesionesUsuarios.php?CrediAgil=iniciarsesion" autocomplete="off">
