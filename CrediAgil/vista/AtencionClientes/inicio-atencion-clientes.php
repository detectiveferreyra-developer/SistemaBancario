    ...
    ***********************************-->
        ...
        ***********************************-->
            <div class="nav-header">
                <a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=inicioatencionclientes"
                    class="brand-logo">
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            ...
                            <ul class="navbar-nav header-right">
                                <li class="nav-item dropdown notification_dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="all-notification"
                                            href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=visualizar-mis-notificaciones-usuarios-atencion-clientes">Ver
                                ...
                                <li class="nav-item dropdown header-profile">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="<?php echo $UrlGlobal ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=perfilatencionclientes"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card-tech-detail tech-transactions">
                                            <div class="info">
                                                ...
                                                <h2><?php if (empty($Gestiones->getTotalTransaccionesProcesadas_AtencionClientes())) {
                                                    echo "0";
                                                } else {
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card-tech-detail tech-products">
                                            <div class="info">
                                                ...
                                                <h2><?php if (empty($Gestiones->getTotalSolicitudesCreditosProcesadas_AtencionClientes())) {
                                                    echo "0";
                                                } else {
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card-tech-detail tech-installments">
                                            <div class="info">
                                                ...
                                                <h2>$<?php echo number_format($Gestiones->getTotalIngresosTransaccionesCreditos_AtencionClientes(), 2); ?></h2>
                                            </div>
                                            <div class="icon-box">
