                            ...
                            <ul class="navbar-nav header-right">
                                <li class="nav-item dropdown notification_dropdown">
                                    <a class="nav-link  ai-icon" href="#" role="button" data-toggle="dropdown">
                                        ...
                                        <span
                                            class="badge light text-white bg-primary"><?php echo NumeroNotificacionesRecibidasUsuarios($conectarsistema3, $_SESSION['id_usuario']); ?></span>
                                    </a>
                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Consultar Detalle Usuarios</a>
                            </li>
                        </ol>
                    </div>
                    <!-- row -->
                                ...
                                <div class="profile-head">
                                    ...
                                    <div class="profile-info">
                                        <div class="profile-photo">
                                            <img style="width: 100%; max-width: 220px; max-height: 130px"
                                                src="<?php echo $UrlGlobal; ?>vista/images/fotoperfil/<?php echo $Gestiones->getFotoUsuarios(); ?>"
                                ...
                                <div class="profile-tab">
                                    <div class="custom-tab-1">
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item"><a href="#detalles_usuarios" data-toggle="tab"
                                                    class="nav-link active show">Detalles Completo Usuario</a>
                                            </li>
                                            <li class="nav-item"><a href="#documentos_usuarios" data-toggle="tab"
                                                    class="nav-link">Documentos Personales</a>
                                            </li>
                                            </li>
                                        </ul>
                                                ...
                                                <div class="pt-3">
                                                    <div class="settings-form">
                                                        <div
                                                            ...
                                                            $PrimerNombre = explode(' ', $Nombre, 2);
                                                            print_r($PrimerNombre[0]); ?>, es su responsabilidad
                                                            verificar que todos los datos deben coincidir antes de realizar
                                                            cualquier transacci&oacute;n con dicho usuario. <strong>Si usted
                                                                encuentra irregularidades, o simplemente el Dui se encuentra
                                                                vencido. Expl&iacute;quele al usuario los motivos del por
                                                                qu&eacute; su transacci&oacute;n no puede ser
                                                                completada.</strong>
                                                        </div>
                                                        <h4 class="text-primary"><i class="ti-bookmark"></i> Documento
                                                            &Uacute;nico de Identidad [Frente] <i
                                                                class="ti-layout-media-left"></i> </h4><br>
                                                        <img style="max-width: 500px; margin: 0 auto; display: block;"
                                                            class="img-fluid"
                                                            src="<?php echo $UrlGlobal;
                                                            echo "vista/images/fotoduifrontal/";
                                                            echo $Gestiones->getFotoDuiFrontalUsuarios(); ?>"><br><br>
                                                        <h4 class="text-primary"><i class="ti-bookmark"></i> Documento
                                                            &Uacute;nico de Identidad [Reverso] <i
                                                                class="ti-layout-media-right"></i> </h4><br>
                                                        <img style="max-width: 500px; margin: 0 auto; display: block;"
                                                            class="img-fluid"
                                                            src="<?php echo $UrlGlobal;
                                                            echo "vista/images/fotoduireverso/";
                                                            echo $Gestiones->getFotoDuiReversoUsuarios(); ?>"><br><br>
                                                        <h4 class="text-primary"><i class="ti-bookmark"></i> N&uacute;mero
                                                            de Identificaci&oacute;n Tributaria</h4><br>
                                                        <img style="max-width: 500px; margin: 0 auto; display: block;"
                                                            class="img-fluid"
                                                            src="<?php echo $UrlGlobal;
                                                            echo "vista/images/fotonit/";
                                                            echo $Gestiones->getFotoNitUsuarios(); ?>"><br><br>
                                                        <h4 class="text-primary"><i class="ti-bookmark"></i> Firma de
                                                            Usuario</h4><br>
                                                        <img style="max-width: 500px; margin: 0 auto; display: block;"
                                                            class="img-fluid"
                                                            src="<?php echo $UrlGlobal;
                                                        ...
                                                        <h4 class="text-primary"><i class="ti-bookmark"></i> Descarga
                                                            Multimedia</h4><br>
                                                        <!-- DESCARGA DUI FRENTE DOCUMENTO -->
                                                        <a href="<?php echo $UrlGlobal;
                                                        echo "vista/images/fotoduifrontal/";
                                                        echo $Gestiones->getFotoDuiFrontalUsuarios(); ?>"
                                                            download="DetalleUsuarioMultimediaDuiFrente_<?php echo $Gestiones->getFotoDuiFrontalUsuarios(); ?>">
                                                            <button type="button" class="btn btn-rounded btn-warning"><span
                                                                    class="btn-icon-left text-warning"><i
                                                                        class="fa fa-download color-warning"></i></span>Descargar
                                                                Dui [Frente]</button>
                                                            <!-- DESCARGA DUI REVERSO DOCUMENTO -->
                                                            <a href="<?php echo $UrlGlobal;
                                                            echo "vista/images/fotoduireverso/";
                                                            echo $Gestiones->getFotoDuiReversoUsuarios(); ?>"
                                                                download="DetalleUsuarioMultimediaDuiReverso_<?php echo $Gestiones->getFotoDuiReversoUsuarios(); ?>">
                                                                <button type="button"
                                                                ...
                                                                <a href="<?php echo $UrlGlobal;
                                                                echo "vista/images/fotonit/";
                                                                echo $Gestiones->getFotoNitUsuarios(); ?>"
                                                                    download="DetalleUsuarioMultimediaNit_<?php echo $Gestiones->getFotoNitUsuarios(); ?>">
                                                                    <button type="button"
                                                                        class="btn btn-rounded btn-warning"><span
                                                                            class="btn-icon-left text-warning"><i
                                                                                class="fa fa-download color-warning"></i></span>Descargar
                                                                    ...
                                                                    <a href="<?php echo $UrlGlobal;
                                                                    echo "vista/images/fotofirmas/";
                                                                    echo $Gestiones->getFotoFirmaUsuarios(); ?>"
                                                                        download="DetalleUsuarioMultimediaFirma_<?php echo $Gestiones->getFotoFirmaUsuarios(); ?>">
                                                                        <button type="button"
                                                                            class="btn btn-rounded btn-warning"><span
                                                                                class="btn-icon-left text-warning"><i
                                                                                    class="fa fa-download color-warning"></i></span>Descargar
