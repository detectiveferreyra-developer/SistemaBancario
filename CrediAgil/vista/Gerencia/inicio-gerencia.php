                            ...
                            <ul class="navbar-nav header-right">
                                ...
                                <li class="nav-item dropdown header-profile">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=mensajeria-CrediAgil-usuarios-gerencia"
                                            class="dropdown-item ai-icon">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body row sp16">
                                    <div class="col-xl-4 mb-3 col-lg-12 col-md-6">
                                        <div class="bgl-primary border border-primary media align-items-center p-4">
                                            <div class="media-body">
                                                <span class="fs-14 font-w600">Productos Registrados</span>
                                                <h2 class="text-black fs-28 mb-2 font-w600">
                                                    <?php echo $Gestiones->getNumeroProductosRegistrados(); ?>
                                                </h2>
                                            </div>
                                            <img style="width: 4em;" class="mr-3"
                                                src="<?php echo $UrlGlobal; ?>vista/images/money-bag.gif" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 mb-3 col-lg-12 col-md-6">
                                        <div class="bgl-info border border-success media align-items-center p-4">
                                            <div class="media-body">
                                                ...
                                                <h2 class="text-black fs-28 mb-2 font-w600">
                                                    <?php echo $Gestiones->getNumeroCuotasClientesRegistradas(); ?>
                                                </h2>
                                            </div>
                                            <img style="width: 4em;" class="mr-3"
                                                src="<?php echo $UrlGlobal; ?>vista/images/note.gif" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 mb-3 col-lg-12 col-md-6">
                                        <div
                                            class="bgl-dark border-info border border-warning media align-items-center p-4">
                                            <div class="media-body">
                                                <span class="fs-14 font-w600">Transacciones Cr&eacute;ditos
                                                    Registradas</span>
                                                <h2 class="text-black fs-28 mb-2 font-w600">
                                                    <?php echo $Gestiones->getNumeroTransaccionesClientesRegistradas(); ?>
                                                </h2>
                                            </div>
                                            <img style="width: 4em;" class="mr-3"
                                                src="<?php echo $UrlGlobal; ?>vista/images/cash.gif" alt="">
                                        </div>
                                    </div>

                                    <div class="col-xl-4 mb-3 col-lg-12 col-md-6">
                                        <div
                                            class="bgl-dark border-danger border border-danger media align-items-center p-4">
                                            <div class="media-body">
                                                <span class="fs-14 font-w600">Cuotas Canceladas Tarde</span>
                                                <h2 class="text-black fs-28 mb-2 font-w600">
                                                    <?php echo $Gestiones->getNumeroCuotasPagadasTarde(); ?>
                                                </h2>
                                            </div>
                                            <img style="width: 4em;" class="mr-3"
                                                src="<?php echo $UrlGlobal; ?>vista/images/warning.gif" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 mb-3 col-lg-12 col-md-6">
                                        <div
                                            class="bgl-dark border-success border border-success media align-items-center p-4">
                                            <div class="media-body">
                                                <span class="fs-14 font-w600">Cuotas Procesadas / Canceladas</span>
                                                <h2 class="text-black fs-28 mb-2 font-w600">
                                                    <?php echo $Gestiones->getNumeroCuotasPagadasCanceladas(); ?>
                                                </h2>
                                            </div>
                                            <img style="width: 4em;" class="mr-3"
                                                src="<?php echo $UrlGlobal; ?>vista/images/handshake.gif" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 mb-3 col-lg-12 col-md-6">
                                        <div class="bgl-dark border-dark border border-dark media align-items-center p-4">
                                            <div class="media-body">
                                                ...
                                                <h2 class="text-black fs-28 mb-2 font-w600">
                                                    <?php echo $Gestiones->getNumeroCuotasVencidas(); ?>
                                                </h2>
                                            </div>
                                            <img style="width: 4em;" class="mr-3"
                                                src="<?php echo $UrlGlobal; ?>vista/images/no.gif" alt="">
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-12 col-xxl-12 col-lg-12 col-sm-12">
                            <div class="card">
                                <div class="card-header border-0">
                                    ...
                                    <p class="mb-0 fs-13">Detalle de las &uacute;ltimas 200 transacciones procesadas
                                        ...
                                        <table class="table bg-warning-hover text-center">
                                            <thead style="background: #000; color: #fff;">
                                                <tr>
                                                    ...
                                                    <th class="text-center"><i class="fa fa-info-circle"></i>
                                                        Descripci&oacute;n Transacciones</th>
