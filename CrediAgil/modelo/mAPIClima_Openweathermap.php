...
// CONFIGURACION DE TIEMPOS DE ESPERA -> EVITAR BLOQUEO DE CARGA SISTEMA
curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 5); // 5 SEGUNDOS DE ESPERA PARA CONECTAR
curl_setopt($ch, CURLOPT_TIMEOUT, 5); // 5 SEGUNDOS DE ESPERA PARA EJECUCION
