...
-->
    ...
    <head>
        ...
        <title>CrediAgil | Gestor de Nuevos Cr&eacute;ditos CrediAgil</title>
        <!-- Favicon icon -->
        <link rel="apple-touch-icon" sizes="57x57" href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-57x57.png">
        <link rel="apple-touch-icon" sizes="60x60" href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-60x60.png">
        <link rel="apple-touch-icon" sizes="72x72" href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-72x72.png">
        <link rel="apple-touch-icon" sizes="76x76" href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-76x76.png">
        <link rel="apple-touch-icon" sizes="114x114" href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-114x114.png">
        <link rel="apple-touch-icon" sizes="120x120" href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-120x120.png">
        <link rel="apple-touch-icon" sizes="144x144" href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-144x144.png">
                            ...
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <div class="auth-form">
                                        ...
                                        <div class="card overflow-hidden">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    ...
                                                    <p>Cliente CrediAgil</p>
                                                    <p>Multimedia Documentos Personales Clientes CrediAgil</p>
                                                </div><br>
                                                <div class="col-xl-12">
                                                    <!-- FOTO DUI CLIENTES -->
                                                        ...
                                                        <div class="media">
                                                            <div class="media-body">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=gestor-creditos-seleccion-producto-clientes&idusuario=<?php echo $Gestiones->getIdUsuarios(); ?>" class="btn light btn-light"><i class="fa fa-check-circle-o"></i> Continuar con el proceso</a>
                                                                <?php } else { ?>
                                                                ...
                                                                <?php } ?>
                                                                <a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=asignacion-nuevos-creditos-clientes" class="btn light btn-light"><i class="fa fa-trash"></i> Salir del proceso</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <h6 class="text-center">&copy; Copyright <?php echo date('Y'); ?> CrediAgil</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
