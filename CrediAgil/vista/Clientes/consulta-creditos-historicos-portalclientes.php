...
-->
    ...
    <head>
        ...
        <title>CrediAgil | Listado Solicitudes Cr&eacute;ditos Cancelados (Hist&oacute;rico) </title>
        <!-- Favicon icon -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Solicitudes Cr&eacute;ditos Cancelados Clientes CrediAgil [Hist&oacute;rico]</h4><br>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
												...
												<td>
                                                    <a target="_blank" style="width: 100%" href="';
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-especifica-solicitudes-creditos-canceladas-historico-portal-clientes&idusuario=';
