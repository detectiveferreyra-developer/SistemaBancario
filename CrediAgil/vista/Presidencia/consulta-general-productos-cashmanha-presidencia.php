...
-->
    ...
    <head>
        ...
        <title>CrediAgil | Consulta General de Productos</title>
        <!-- Favicon icon -->
    ...
    ***********************************-->
        ...
        ***********************************-->
            <div class="nav-header">
                <a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=iniciopresidencia" class="brand-logo">
                            ...
                            <ul class="navbar-nav header-right">
                                <li class="nav-item dropdown notification_dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="all-notification" href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=visualizar-mis-notificaciones-usuarios-presidencia">Ver Mis Notificaciones <i class="ti-arrow-right"></i></a>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item dropdown header-profile">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="<?php echo $UrlGlobal ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=perfilpresidencia" class="dropdown-item ai-icon">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar, Gestionar Productos CrediAgil</h4><br>
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a target="_blank" class="dropdown-item" href="';
                                                                echo $UrlGlobal;
                                                                echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-productos-especifica-CrediAgil-presidencia&idproducto=';
                                                                echo $filas['idproducto'];
                                                                echo '"><i class="ti-eye"></i> Ver Producto</a>
															<a class="dropdown-item" href="';
                                                                echo $UrlGlobal;
                                                                echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=modificar-productos-CrediAgil-presidencia&idproducto=';
                                                                echo $filas['idproducto'];
                                        ...
                                        <div class="tab-pane fade" id="profile8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar, Gestionar Productos Inactivos CrediAgil</h4><br>
                                                <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                                $PrimerNombre = explode(' ', $Nombre, 2);
                                                ...
                                                <div class="col-lg-12 mb-2">
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a target="_blank" class="dropdown-item" href="';
                                                                    echo $UrlGlobal;
                                                                    echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-productos-especifica-CrediAgil&idproducto=';
                                                                    echo $filas['idproducto'];
                                                                    echo '"><i class="ti-eye"></i> Ver Producto</a>
															<a class="dropdown-item" href="';
                                                                    echo $UrlGlobal;
                                                                    echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=modificar-productos-CrediAgil&idproducto=';
                                                                    echo $filas['idproducto'];
                                                                    echo '"><i class="ti-pencil-alt2"></i> Modificar Producto</a>
															<a style="cursor: pointer;" data-id="';
                                                                    echo $filas['idproducto'];
                                        ...
                                        <div class="tab-pane fade" id="profile9" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar, Gestionar Productos Expirados CrediAgil</h4><br>
                                                <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                                $PrimerNombre = explode(' ', $Nombre, 2);
    ...
    ***********************************-->
        ...
        <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-desactivar-productos-CrediAgil.js"></script>
        <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-expirar-productos-CrediAgil.js"></script>
        <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-activar-productos-CrediAgil.js"></script>
