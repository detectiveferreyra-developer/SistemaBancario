...
-->
	...
	<head>
		...
		<title>CrediAgil | Consulta General Roles de Usuarios</title>
		<!-- Favicon icon -->
							...
							<div class="card-body">
								...
								<div class="tab-content tabcontent-border">
									<div class="tab-pane fade show active" id="home8" role="tabpanel">
										<div class="pt-4">
											<h4>Consultar, Gestionar Roles de Usuarios CrediAgil</h4><br>
												...
												<table style="width: 100%;" id="example5" class="display min-w850">
													...
													<div class="dropdown">
														...
														<a class="dropdown-item" href="';
															echo $UrlGlobal;
															echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=modificar-roles-usuarios&idunicorolusuarios=';
															echo $filas['idrol'];
