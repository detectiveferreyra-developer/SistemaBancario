...
$("#gestion-nuevos-usuarios").submit(function(event) {
    ...
    if($ContraseniaUsuarios.length < 9) {
        ...
        $.ajax({
            type: "POST",
            url: "../controlador/cGestionesCrediAgil.php?CrediAgilgestion=envio-datos-gestiones-nuevos-usuarios-registrados",
            data: parametros,
            ...
            success: function(datos) {
                ...
                // SI LA PETICION ES ACEPTADA, MOSTRAR MENSAJE DE CONFIRMACION DE PETICION EXITOSA -> MENSAJE FLOTANTE
                    ...
                    setTimeout(function () {
                        location.href = "../controlador/cIniciosSesionesUsuarios.php?CrediAgil=cerrarsesion";
                    }, 5500);
                }
