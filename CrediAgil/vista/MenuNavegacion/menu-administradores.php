            ...
            <ul class="metismenu" id="menu">
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
                    ...
                    <ul aria-expanded="false">
                        <li><a
                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=inicioadministradores">Mi
                                Inicio</a></li>
                        <li><a
                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=perfiladministradores">Mi
                                Perfil</a></li>
                    </ul>
                </li>
                <li><a class="ai-icon"
                ...
                <li <?php if ($_GET['CrediAgilgestion'] == "sistema-pagos-creditos-CrediAgil-clientes" || $_GET['CrediAgilgestion'] == "orden-pago-creditos-CrediAgil-clientes") {
                    ...
                    <ul aria-expanded="false">
                        ...
                        } ?>   href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=listado-general-creditos-aprobados-activos">Listado
                                de Clientes</a></li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
                    ...
                    <ul aria-expanded="false">
                        <li><a
                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-listado-cuotas-clientes-morosos">Listado
                ...
                <li <?php if ($_GET['CrediAgilgestion'] == "consulta-especifica-tickets-reportes-plataforma") {
                    ...
                    <ul aria-expanded="false">
                        <li><a
                                href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=registrar-ticket-problema-plataforma">Registrar
                                Reportes Problemas</a></li>
                        <li><a <?php if ($_GET['CrediAgilgestion'] == "consulta-especifica-tickets-reportes-plataforma") {
                            echo 'class="active-element-menu"';
                        } ?> href="<?php echo $UrlGlobal; ?>controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-listado-tickets-reportes-plataforma">Listado
                                Reportes Problemas</a></li>
                    </ul>
                </li>
