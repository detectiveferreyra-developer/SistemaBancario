                        ...
                        <div class="col-xl-12">
                            <div id="accordion-six" class="accordion accordion-with-icon accordion-danger-solid">
                                <div class="accordion__item">
                                    ...
                                    <div id="with-icon_collapseOne" class="accordion__body collapse"
                                        data-parent="#accordion-six">
                                        <div class="accordion__body--text">
                                            <i class="ti-direction"></i> Usted podr&aacute; consultar, gestionar, desactivar
                                            y expirar productos en este apartado, en estos momentos se explica brevemente
                                            los diferentes significados de los &iacute;conos [izquierda - derecha]:
                                            <br>[ <i class="mdi mdi-file-plus"></i> Consultar y Gestionar Productos Activos
                                            ]
                                            <br>[ <i class="mdi mdi-file-lock"></i> Consultar y Gestionar Productos
                                            Inactivos ]
                                            <br>[ <i class="mdi mdi-file-excel"></i> Consultar y Gestionar Productos
                                            Expirados ]
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                            <div class="pt-4">
                                                ...
                                                print_r($PrimerNombre[0]); ?>, en este apartado
                                                    encontrar&aacute;s el listado completo de todos los productos
                                                    registrados. <strong>Por favor toma en cuenta que aqu&iacute; solamente
                                                        se muestran todos los productos activos y funcionales
                                                        &uacute;nicamente.</strong></p>
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a target="_blank" class="dropdown-item" href="';
                                                                echo $UrlGlobal;
                                                                echo 'controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-productos-especifica-CrediAgil-gerencia&idproducto=';
                                        ...
                                        <div class="tab-pane fade" id="profile8" role="tabpanel">
                                            <div class="pt-4">
                                                ...
                                                print_r($PrimerNombre[0]); ?>, en este apartado
                                                    encontrar&aacute;s el listado completo de todos los productos
                                                    registrados que se encuentran inactivos.</p>
                                        ...
                                        <div class="tab-pane fade" id="profile9" role="tabpanel">
                                            <div class="pt-4">
                                                ...
                                                print_r($PrimerNombre[0]); ?>, en este apartado
                                                    encontrar&aacute;s el listado completo de todos los productos
                                                    registrados que se han expirado en su oferta a los clientes.</p>
                                                <div class="col-xl-12">
                                                    <div class="table-responsive">
                                                        <table style="width: 100%;" id="example5" class="display min-w850">
                                                            <thead>
