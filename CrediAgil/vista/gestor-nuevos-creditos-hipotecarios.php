...
if ($_SESSION['comprobar_iniciosesion_primeravez'] == "si") {
    ...
    */
    ...
    // SOLAMENTE CLIENTES DE RANGOS 18 A 70 A�OS
...
?>
        ...
        <head>
            ...
            <title>CrediAgil | Gestor Nuevos Pr&eacute;stamos Hipotecarios</title>
            <!-- Favicon icon -->
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <select class="form-control" id="val-productocreditos" name="productocreditos">
                                                                                        ...
                                                                                        while ($filas = mysqli_fetch_array($consulta1)) {
                                                                                            ...
                                                                                            if ($filas['nombreproducto'] != "Cuentas de Ahorro Personales" && $filas['nombreproducto'] != "Dep�sito a Plazo Fijo" && $filas['nombreproducto'] != "Pr�stamos Personales" && $filas['nombreproducto'] != "Pr�stamos de Veh�culos") {
                                                                                                echo '
                                                                    <option value="';
...
<?php
        ...
        header('location:../controlador/cGestionesCrediAgil.php?CrediAgilgestion=gestor-creditos-clientes-informacion&idusuario=' . $Gestiones->getIdUsuarios());
    }
}
?>
