													...
													<div class="settings-form">
														...
														<form id="actualizar-configuracion-cuenta" class="form-valide1"
															...
															<div class="row form-validation">
																...
																<div class="col-lg-6 mb-2">
																	<div class="form-group">
																		<label class="text-label">Usuario &Uacute;nico <span
																				class="text-danger">*</span></label>
																		<div class="col-lg-12">
																			<input type="text" class="form-control"
																				id="val-usuariounico"
																				name="val-usuariounico"
																				placeholder="Ingrese su usuario &uacute;nico"
																				value="<?php echo $Gestiones->getCodigoUsuarios(); ?>"
														...
														<div class="form-validation">
															<form id="actualizar-perfil-detalles-usuarios"
																...
																<div class="row form-validation">
																	<div class="col-lg-6 mb-2">
																		<div class="form-group">
																			<label class="text-label">Dui <span
																					class="text-danger">*</span></label>
																			<div class="col-lg-12">
																				<input type="text" class="form-control"
																	...
																	<div class="col-lg-6 mb-2">
																		<div class="form-group">
																			<label class="text-label">Nit <span
																					class="text-danger">*</span></label>
																			<div class="col-lg-12">
																				<input type="text" class="form-control"
																	...
																	<div class="col-lg-6 mb-2">
																		<div class="form-group">
																			<label class="text-label">Fecha de Nacimiento
																				<span class="text-danger">*</span></label>
																			<div class="col-lg-12">
																				<input type="text" class=" form-control"
