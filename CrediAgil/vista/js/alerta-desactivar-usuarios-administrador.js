    ...
    swal.fire({
     ...
     preConfirm: function() {
       return new Promise(function() {
          $.ajax({
          url: '../controlador/cGestionesCrediAgil.php?CrediAgilgestion=desactivar-usuarios-clientes&idusuario='+IDUsuarios,
          type: 'POST',
          ...
          .done(function(respuesta){ // SI MODELO EJECUTA PETICION, REALIZA PETICION
            if(respuesta=="OK"){
                AlertaUsuarioMostrar("Usuario Desactivado","Su petición se ha completado con éxito","success");
