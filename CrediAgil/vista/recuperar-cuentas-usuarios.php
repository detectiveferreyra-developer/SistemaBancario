...
if ($_GET['token'] != $_SESSION['TokenUsuarios']) {
    $urltoken = $_GET['token'];
    $URL = "../controlador/cIniciosSesionesUsuarios.php?CrediAgil=token-codigo-invalido&token=$urltoken";
    header("location: $URL");
} else {
    /*
...
-->
        ...
        <head>
            ...
            <link rel="apple-touch-icon" sizes="60x60"
                href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-60x60.png">
            <link rel="apple-touch-icon" sizes="72x72"
                href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-72x72.png">
            <link rel="apple-touch-icon" sizes="76x76"
                href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-76x76.png">
            <link rel="apple-touch-icon" sizes="114x114"
                href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-114x114.png">
            <link rel="apple-touch-icon" sizes="120x120"
                href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-120x120.png">
            <link rel="apple-touch-icon" sizes="144x144"
                href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-144x144.png">
            <link rel="apple-touch-icon" sizes="152x152"
                href="<?php echo $UrlGlobal; ?>vista/images/crediagil-apple-icon-152x152.png">
                ...
                <div class="alert alert-danger left-icon-big alert-dismissible fade show">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="mb-0">Por seguridad, nuestro sistema cuenta con un tiempo establecido para que pueda
                                realizar el cambio de su nueva contrase&ntilde;a.</p>
                            <p class="mb-0">Usted dispone de <span id="cronometro"></span> segundos para realizar el cambio de
                        ...
                        <div class="col-md-6">
                            <div class="authincation-content">
                                <div class="alert alert-dark alert-dismissible alert-alt solid fade show">
                                    <strong>Sugerencias</strong> <br><i style="font-size: .7rem" class="fa fa-quote-right"></i>
                                    Su contrase&ntilde;a debe contener al menos 8 car&aacute;cteres.<br><i
                                        style="font-size: .7rem" class="fa fa-quote-right"></i> Le sugerimos hacer uso de
                                    combinaci&oacute;n de may&uacute;sculas, min&uacute;sculas, n&uacute;meros, espacios y
                                    car&aacute;cteres especiales.<br>
                                    <i style="font-size: .7rem" class="fa fa-quote-right"></i> Nunca comparta su
                                    contrase&ntilde;a con otra persona.<br>
                                    <i style="font-size: .7rem" class="fa fa-quote-right"></i> Por favor tome nota del nivel de
                                    seguridad que nuestro sistema detecta en su nueva contrase&ntilde;a.
                                </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="auth-form">
                                            ...
                                            <form class="form-valide" method="POST"
                                                action="<?php echo $UrlGlobal; ?>controlador/cIniciosSesionesUsuarios.php?CrediAgil=cambiar-contrasenia-recuperacion">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append show-pass">
                                                            <button class="background-password btn btn-dark"
                                                                style="height: auto;" id="show_password"
                                                                class="input-group-text" type="button"
                                                                onclick="mostrarPassword()"> <span style="font-size: 1rem;"
                                                                    class="fa fa-eye-slash show-password"></span> </button>
                                                        </div>
                                                    </div><br>
                                                    <span id="passstrength"></span>
                                                    <div class='text-center'><button id='enviodatos' type='submit'
                                                            class='btn btn-primary btn-block'> Cambiar
