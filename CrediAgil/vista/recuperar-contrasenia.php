							...
							<div class="row no-gutters">
								<div class="col-xl-12">
									<div class="auth-form">
										...
										<form id="recuperar-cuentas" class="form-valide" method="POST" action="<?php echo $UrlGlobal; ?>controlador/cIniciosSesionesUsuarios.php?CrediAgil=recuperar-cuentas">
