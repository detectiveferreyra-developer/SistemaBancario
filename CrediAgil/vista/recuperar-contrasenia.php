...
<head>
	...
	<title>CrediAgil | Recuperar Contrase&ntilde;a</title>
	<!-- Favicon icon -->
					...
					<div class="alert alert-primary left-icon-big alert-dismissible fade show">
						...
						<div class="media">
							...
							<div class="media-body">
								...
								<p class="mb-0">Por favor ingrese su correo y nuestro sistema verificar&aacute; si su
									usuario existe para proceder con la recuperaci&oacute;n de su cuenta.<strong> El
										proceso debe ser iniciado y finalizado en este dispositivo, de lo contrario no
										podr&aacute; continuar con el proceso de recuperaci&oacute;n de
										cuentas.</strong></p>
							</div>
						</div>
					</div>
						...
						<div class="row no-gutters">
							<div class="col-xl-12">
								<div class="auth-form">
									...
									<form id="recuperar-cuentas" class="form-valide" method="POST"
										action="<?php echo $UrlGlobal; ?>controlador/cIniciosSesionesUsuarios.php?CrediAgil=recuperar-cuentas">
										<div class="form-group">
											<label class="text-label">Correo Electr&oacute;nico</label>
											<div class="input-group">
												<input type="email" class="form-control" id="val-email" name="val-email"
													placeholder="Ingresa tu correo..." onBlur="comprobarUsuario()">
												<div class="col-md-12">
													<span id="estadousuario"></span>
												</div>
												<p class="mt-3"><img style="width: 25px; display:none;"
														src="../vista/images/Spinner.svg" id="loaderIcon" /></p>
											</div>
										</div>
										...
										<div class="text-center mt-4">
											<a
												href="<?php echo $UrlGlobal; ?>controlador/cIniciosSesionesUsuarios.php?CrediAgil=iniciarsesion">Volver
												al Inicio Sesi&oacute;n</a>
										</div>
									</form>
								</div>
							</div>
