...
$(document).ready(function(){
    $("#registro-usuarios-administradores").on('submit',(function(e){ // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
        ...
        $.ajax({
            url: "../controlador/cGestionesCrediAgil.php?CrediAgilgestion=envio-datos-registro-usuarios-administrador",
            type: "POST",
            dataType: 'json',
            ...
            if($resultado === "OK"){
                //window.open('../controlador/cGestionesCrediAgil.php?CrediAgilgestion=mostrar-informe-nuevos-clientes-administrador', '_blank');
                ...
                setTimeout(function(){
                    location.href="../controlador/cGestionesCrediAgil.php?CrediAgilgestion=registro-usuarios-administrador";
                }, 1500);
