$(document).ready(function () {
    $("#ingreso-datos-credito-clientes").on('submit', (function (e) { // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
        ...
        if ($ObservacionesActualizacionSolicitudesCreditos === "") {
            ...
            $.ajax({
                url: "../controlador/cGestionesCrediAgil.php?CrediAgilgestion=envio-datos-revisiones-solicitudes-nuevas-creditos-clientes",
                type: "POST",
                dataType: 'json',
                ...
                if ($resultado === "OK") {
                    ...
                    setTimeout(function () {
                        //location.reload();
                        location.href ="../controlador/cGestionesCrediAgil.php?CrediAgilgestion=gestionar-solicitudes-creditos-asignados-clientes-gerencia";
                    }, 1500);
