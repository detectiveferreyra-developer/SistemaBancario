$(document).ready(function(){
    $("#modificar-detalles-clientes-usuarios").on('submit',(function(e){ // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
        ...
        $.ajax({
            url: "../controlador/cGestionesCrediAgil.php?CrediAgilgestion=envio-datos-modificar-detalles-usuarios-administrador",
            type: "POST",
            dataType: 'json',
            ...
            if($resultado === "OK"){
                ...
                setTimeout(function(){
                    location.href="../controlador/cGestionesCrediAgil.php?CrediAgilgestion=consulta-general-usuarios-administrador";
                }, 1500);
